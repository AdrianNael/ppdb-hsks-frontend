    ...
    <div className="block rounded-lg bg-biruprimary text-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20p x_-2px_rgba(0,0,0,0.04)]">
      <div className="relative">
        ...
        <div className="font-black text-stroke-blue">
          <h6 className="absolute font-bold text-xs w-3/4 text-white bottom-2 left-2">HOMESCHOOLING KAK SETO PUSAT</h6>
        </div>
      </div>
      <div className="p-4">
        <div className="grid grid-cols-2">
          <h5 className="mb-2 text-sm font-medium leading-tight">Sekolah Formal</h5>
        ...
        <h5 className="text-sm font-medium leading-tight mt-4 mb-1 text-[10px]">Program Tersedia :</h5>
      ...
      <div className="fix-button flex items-end justify-center">
        <button type="button" className="rounded px-7 py-2 text-xs font-medium border-2 border-white text-white mb-4" data-te-ripple-init data-te-ripple-color="light">
          Pilih
        </button>
      </div>
    </div>
