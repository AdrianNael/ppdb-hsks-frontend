...
function Body8() {
  ...
  return (
    ...
    <BreadCrumbs />
     ...
     <div className="container mx-auto mt-8" onDragOver={handleDragOver} onDrop={handleDrop}>
      <div className="rounded-lg shadow-xl bg-gray-50 lg:w-1/2 mx-auto lg:mx-0">
        <div className="m-4">
          ...
          <div className="flex items-center justify-center w-full">
            <label className="flex flex-col w-full h-32 border-4 border-dashed hover:bg-gray-100 hover:border-gray-300">
              <div className="flex flex-col items-center justify-center pt-7">
                <FontAwesomeIcon icon={faFileAlt} size="3x" color="#718096" />
